...
{type:'life',date:'After LECA',title:'Eukaryotes diversify',major:true,summary:'Eukaryotic lineages spread into a huge variety of unicellular and multicellular forms. The story now branches rather than following one straight line.',why:'Modern animals, fungi, plants, algae and numerous protist lineages are distant branches of this diversification.',flow:'Eukaryotes → many major clades',details:['Living unicellular examples: amoebae, Paramecium, Euglena, dinoflagellates, diatoms, yeasts and choanoflagellates.','Modern single-celled eukaryotes are not “primitive animals”; they are their own living lineages.']},
...
{type:'life',date:'Ancient; exact timing debated',title:'Secondary endosymbiosis involving a red alga',major:true,summary:'A different eukaryotic host incorporates an already photosynthetic red alga. This is eukaryote-within-eukaryote endosymbiosis rather than bacterium-within-eukaryote endosymbiosis.',why:'Red-algal plastids spread into other eukaryotic lineages, including the lineage associated with stramenopiles and brown algae.',uncertainty:'The history of complex red-derived plastids is actively debated, including whether all such plastids trace to one or multiple secondary events.',flow:'Eukaryotic host + red alga → complex red-derived plastid'},
{type:'life',date:'Later Proterozoic to Paleozoic diversification',title:'Stramenopiles and brown algae',summary:'Within the stramenopile radiation, photosynthetic lineages with red-derived plastids diversify; brown algae eventually emerge as a distinct multicellular lineage.',why:'This pathway explains why brown algae photosynthesize but are not plants.',uncertainty:'Deep divergence dates for brown algae vary across molecular-clock studies.',flow:'Stramenopile lineage → brown algae'},
